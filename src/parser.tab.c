...
{
      13,     0,    -1,    14,    -1,    13,     5,    14,    -1,    13,
       6,    14,    -1,    15,    -1,    14,     7,    15,    -1,    16,
      -1,    15,     8,     3,     9,    10,    -1,    15,     8,     3,
       9,    17,    10,    -1,     3,    -1,     9,    13,    10,    -1,
       4,    -1,    17,    11,     4,    -1
};
...
static const char *const yytname[] =
{
  ...
  "'*'", "'.'", "'('", "')'", "','", "$accept", "set_expression",
  "intersect_expression", "postfix_expression", "primary_expression",
  "argument_list", 0
};
#endif
...
{
       0,   256,   257,   258,   259,    43,    45,    42,    46,    40,
      41,    44
};
# endif
...
{
       0,    10,     0,     0,     2,     5,     7,     0,     1,     0,
       0,     0,     0,    11,     3,     4,     6,     0,     0,    12,
       8,     0,     9,     0,    13
};
...
{
       8,     1,    11,    19,    12,     9,    10,     2,    24,    20,
       9,    10,    22,    23,    17,    13,    14,    15,    18,     7,
       0,    16
};

static const yytype_int8 yycheck[] =
{
       0,     3,     7,     4,     8,     5,     6,     9,     4,    10,
       5,     6,    10,    11,     3,    10,     9,    10,     9,     2,
      -1,    11
};
...
{
       0,     3,     9,    13,    14,    15,    16,    13,     0,     5,
       6,     7,     8,    10,    14,    14,    15,     3,     9,     4,
      10,    17,    10,    11,     4
};
...
#line 52 "parser.y"
    {
		...
		fprintf(script, "sort %s %s %s | uniq -u > %s\n\n", (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]), (yyvsp[(3) - (3)]), (yyval));
	;}
    break;
...
#line 76 "parser.y"
    {
		(yyval) = get_free_variable();
		fprintf(script, "# %s = %s.%s\n", (yyval), (yyvsp[(1) - (5)]), (yyvsp[(3) - (5)]));
		fprintf(script, "gawk -f %s %s > %s\n\n", (yyvsp[(3) - (5)]), (yyvsp[(1) - (5)]), (yyval));
	;}
    break;
...
#line 82 "parser.y"
    {
		(yyval) = get_free_variable();
		fprintf(script, "# %s = %s.%s\n", (yyval), (yyvsp[(1) - (6)]), (yyvsp[(3) - (6)]));
		fprintf(script, "gawk -f %s ", (yyvsp[(3) - (6)]));
...
#line 112 "parser.y"
    {
		add_argument(atof((const char *)(yyvsp[(1) - (1)])));
	;}
    break;
...
#line 116 "parser.y"
    {
		add_argument(atof((const char *)(yyvsp[(3) - (3)])));
	;}
    break;
